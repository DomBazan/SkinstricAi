...
import { ReactComponent as BackButton } from "../svg/button-icon-text-shrunk (3).svg";
import { ReactComponent as ProceedButton } from "../svg/button-icon-text-shrunk (4).svg";
import { ReactComponent as TakePicSVG } from "../svg/camera.svg";
import { ReactComponent as CameraTextSVG } from "../svg/rombuses.svg";
import { ReactComponent as GreatShotSVG } from "../svg/Group 39959.svg";
import { ReactComponent as HeaderWhiteSVG } from "../svg/Rectangle 2779.svg";
...
const BackButtonWhite = ({ onClick, className, ...props }) => (
  <Button onClick={onClick} className={`back-button-white ${className}`} {...props}>
    <BackButton />
  </Button>
);

const ProceedButtonWhite = ({ onClick, className, ...props }) => (
  <Button onClick={onClick} className={`proceed-button-white ${className}`} {...props}>
    <ProceedButton />
  </Button>
);
